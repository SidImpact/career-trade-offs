...
for (const manual of manualCareers) {
  if (!generatedCareers.find(c => c.id === manual.id)) {
    generatedCareers.push(manual);
  }
}
...
console.log("Successfully appended missing careers! Total count: " + generatedCareers.length);
